Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", inline: "dnf install -y epel-release", privileged: true

  # Run Ansible from the Vagrant VM
  config.vm.provision "ansible_local" do |ansible|
    ansible.playbook = "/vagrant/coldfront_app/coldfront/bootstrap/ansible/playbook.yml"
    ansible.galaxy_role_file = "/vagrant/coldfront_app/coldfront/bootstrap/ansible/requirements.yml"
