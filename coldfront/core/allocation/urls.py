...
urlpatterns = [
    ...
    path('<int:pk>/cancel-cluster-account-request/<int:user_pk>',
         allocation_views.AllocationCancelClusterAccountRequestView.as_view(),
         name='allocation-cancel-cluster-account-request'),
