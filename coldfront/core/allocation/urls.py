...
import coldfront.core.allocation.views_.cluster_access_views as cluster_access_views
...
with flagged_paths("SECURE_DIRS_REQUESTABLE") as path:
    flagged_url_patterns = [
        ...
        path(
            "<int:pk>/secure-dir-<str:action>-users/",
        ...
        path(
            "secure-dir-<str:action>-users-request-list/<str:status>",
        ...
        path(
            "<int:pk>/secure-dir-<str:action>-user-update-status",
        ...
        path(
            "<int:pk>/secure-dir-<str:action>-user-complete-status",
        ...
        path(
            "<int:pk>/secure-dir-<str:action>-user-deny-request",
        ...
        path(
            "secure-dir-pending-requests/",
            secure_dir_new_directory_approval_views.SecureDirRequestListView.as_view(
                completed=False
            ),
            name="secure-dir-pending-request-list",
        ),
        path(
            "secure-dir-completed-requests/",
            secure_dir_new_directory_approval_views.SecureDirRequestListView.as_view(
                completed=True
            ),
        ...
        path(
            "secure-dir-request/<int:pk>/notify-pi/",
