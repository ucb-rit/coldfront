...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        attribute_type, _ = AttributeType.objects.get_or_create(name="Text")
        allocation_attr_type, _ = AllocationAttributeType.objects.get_or_create(
        ...
        for status in ["Pending", "Processing", "Complete", "Denied"]:
            SecureDirAddUserRequestStatusChoice.objects.get_or_create(name=status)
            SecureDirRemoveUserRequestStatusChoice.objects.get_or_create(name=status)
