...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        AllocationAttributeType.objects.filter(name="Cluster Account Status").update(
            is_unique=True
        )
        ...
        for choice in choices:
            AllocationRenewalRequestStatusChoice.objects.get_or_create(name=choice)
        ...
        for choice in choices:
            AllocationAdditionRequestStatusChoice.objects.get_or_create(name=choice)

        choices = ["Denied", "Complete", "Pending - Add", "Processing"]
        for choice in choices:
            ClusterAccessRequestStatusChoice.objects.get_or_create(name=choice)
