...
class Command(BaseCommand):
    ...
    def _handle_discrepant_user_attribute(
        self,
        project,
        user,
        allocation_user,
    ...
    def _handle_missing_user_attribute(
        self, project, user, allocation_user, num_service_units, dry_run
    ):
        ...
        for allocation_user in allocation.allocationuser_set.all():
            ...
            try:
                ...
                self._handle_missing_user_attribute(
                    project, user, allocation_user, allocation_service_units, dry_run
                )
            else:
                allocation_user_service_units = Decimal(allocation_user_attribute.value)
                if allocation_user_service_units != allocation_service_units:
