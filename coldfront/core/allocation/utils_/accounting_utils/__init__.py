...
from coldfront.core.utils.common import assert_obj_type, utc_now_offset_aware
...
def set_allocation_service_units_allowance(
    ...
    with transaction.atomic():
        ...
        if change_reason is not None:
            set_latest_history_change_reason(allocation_attribute, change_reason)

    return allocation_attribute


def set_allocation_service_units_usage(
    allocation_attribute_usage, num_service_units, change_reason=None
):
    ...
    with transaction.atomic():
        ...
        if change_reason is not None:
            set_latest_history_change_reason(allocation_attribute_usage, change_reason)


def set_allocation_user_service_units_allowance(
    ...
    with transaction.atomic():
        ...
        if change_reason is not None:
            set_latest_history_change_reason(allocation_user_attribute, change_reason)


def set_allocation_user_service_units_usage(
    allocation_user_attribute_usage, num_service_units, change_reason=None
):
    """Set the number of Service Units for the given
    ...
    with transaction.atomic():
        allocation_user_attribute_usage = model.objects.select_for_update().get(
...
def set_service_units(
    accounting_allocation_objects,
    allocation_allowance=None,
    allocation_usage=None,
    allocation_transaction_date_time=None,
    allocation_change_reason=None,
    user_allowance=None,
    user_usage=None,
    user_transaction_date_time=None,
...
def set_service_units_for_allocation(
    accounting_allocation_objects,
    allowance=None,
    usage=None,
    transaction_date_time=None,
...
def set_service_units_for_allocation_users(
    accounting_allocation_objects,
    allowance=None,
    usage=None,
    transaction_date_time=None,
    ...
    service_units_user_attributes = allocation.allocationuserattribute_set.filter(
        ...
        for allocation_user_attribute in service_units_user_attributes:
            ...
            if set_usage:
                ...
                set_allocation_user_service_units_usage(
                    allocation_user_attribute_usage, usage, change_reason=change_reason
                )
