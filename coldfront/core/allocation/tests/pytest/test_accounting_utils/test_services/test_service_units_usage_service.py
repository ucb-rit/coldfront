...
class TestServiceUnitsUsageServiceUnit:
    ...
    def test_get_usage_display_returns_unlimited_for_non_primary_cluster_project(
        ...
        mock_interface = Mock()
        service = ServiceUnitsUsageService(computing_allowance_interface=mock_interface)
        mock_project = Mock()
    ...
    def test_get_usage_display_returns_na_for_inactive_project(self, mock_is_primary):
    ...
    def test_get_usage_display_returns_recharge_message_for_recharge_allowance(self):
        """Test that recharge allowances show usage-based message."""
        # Mock computing allowance interface
        mock_interface = Mock()
        mock_allowance_obj = Mock()
        mock_interface.allowance_from_project.return_value = mock_allowance_obj
    ...
    def test_get_usage_display_returns_unlimited_for_infinite_service_units(self):
        ...
        mock_computing_allowance.has_infinite_service_units.return_value = True
    ...
    def test_get_usage_display_returns_formatted_usage_for_normal_allocation(
        ...
        mock_computing_allowance = Mock()
        mock_computing_allowance.is_recharge_postpaid.return_value = False
        mock_computing_allowance.has_infinite_service_units.return_value = False
        ...
        result = service.get_usage_display(mock_project, mock_allocation_attr)
    ...
    def test_get_usage_display_returns_failed_to_compute_on_calculation_error(self):
    ...
    def test_should_display_usage_returns_false_for_unlimited(self, mock_is_primary):
    ...
    def test_should_display_usage_returns_false_for_na(self, mock_is_primary):
    ...
    def test_should_display_usage_returns_true_for_normal_allocation(
        ...
        result = service.should_display_usage(mock_project, mock_allocation_attr)

        assert result is True

    def test_no_usage_display_messages_constant_includes_all_special_cases(self):
