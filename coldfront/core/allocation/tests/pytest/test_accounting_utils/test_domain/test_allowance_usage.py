...
from coldfront.core.allocation.utils_.accounting_utils.domain import AllowanceUsage
...
class TestAllowanceUsage:
    ...
    def test_calculate_percentage_with_half_usage(self):
        ...
        usage = AllowanceUsage(allowance=Decimal("100"), usage=Decimal("50"))
    ...
    def test_calculate_percentage_with_zero_usage(self):
        ...
        usage = AllowanceUsage(allowance=Decimal("100"), usage=Decimal("0"))
    ...
    def test_calculate_percentage_with_full_usage(self):
        ...
        usage = AllowanceUsage(allowance=Decimal("100"), usage=Decimal("100"))
    ...
    def test_calculate_percentage_with_over_usage(self):
        ...
        usage = AllowanceUsage(allowance=Decimal("100"), usage=Decimal("150"))
    ...
    def test_calculate_percentage_rounds_to_two_decimals(self):
        ...
        usage = AllowanceUsage(allowance=Decimal("100"), usage=Decimal("33.333333"))
    ...
    def test_calculate_percentage_with_large_numbers(self):
        ...
        usage = AllowanceUsage(allowance=Decimal("1000000"), usage=Decimal("750000"))
    ...
    def test_calculate_percentage_with_fractional_values(self):
        ...
        usage = AllowanceUsage(allowance=Decimal("123.45"), usage=Decimal("67.89"))
    ...
    def test_format_display_with_typical_values(self):
        ...
        usage = AllowanceUsage(allowance=Decimal("1000"), usage=Decimal("750"))
    ...
    def test_format_display_with_zero_usage(self):
        ...
        usage = AllowanceUsage(allowance=Decimal("500"), usage=Decimal("0"))
    ...
    def test_format_display_with_full_usage(self):
        ...
        usage = AllowanceUsage(allowance=Decimal("200"), usage=Decimal("200"))
    ...
    def test_format_display_with_over_usage(self):
        ...
        usage = AllowanceUsage(allowance=Decimal("100"), usage=Decimal("125"))
    ...
    def test_format_display_preserves_decimal_places(self):
        ...
        usage = AllowanceUsage(allowance=Decimal("100.50"), usage=Decimal("25.75"))
    ...
    def test_format_display_with_small_percentage(self):
        ...
        usage = AllowanceUsage(allowance=Decimal("10000"), usage=Decimal("1"))
    ...
    def test_calculate_percentage_division_by_zero_raises_error(self):
        ...
        usage = AllowanceUsage(allowance=Decimal("0"), usage=Decimal("50"))
