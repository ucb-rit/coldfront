...
class AllocationAttributeUsageAdmin(SimpleHistoryAdmin):
    ...
    search_fields = (
        "allocation_attribute__allocation__resources__name",
...
class AllocationUserAttributeAdmin(SimpleHistoryAdmin):
    ...
    inlines = [
        AllocationUserAttributeUsageInline,
    ]
    search_fields = (
...
class AllocationUserAttributeUsageAdmin(SimpleHistoryAdmin):
    ...
    list_filter = (
        "allocation_user_attribute__allocation_attribute_type",
        "allocation_user_attribute__allocation__resources",
        ValueFilter,
    )
    search_fields = (
        "allocation_user_attribute__allocation__project__name",
