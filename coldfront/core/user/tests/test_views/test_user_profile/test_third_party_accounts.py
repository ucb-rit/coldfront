...
class TestThirdPartyAccounts(TestBase):
    ...
    def test_section_disabled_if_flags_disabled(self):
        ...
        # Both enabled
        flags_both_enabled = deepcopy(settings.FLAGS)
        flags_both_enabled[email_flag_name] = [{"condition": "boolean", "value": True}]
        flags_both_enabled[sso_flag_name] = [{"condition": "boolean", "value": True}]
        with override_settings(FLAGS=flags_both_enabled):
        ...
        flags_copy[email_flag_name] = [{"condition": "boolean", "value": False}]
        flags_copy[sso_flag_name] = [{"condition": "boolean", "value": True}]
        ...
        flags_copy[email_flag_name] = [{"condition": "boolean", "value": True}]
        flags_copy[sso_flag_name] = [{"condition": "boolean", "value": False}]
        with override_settings(FLAGS=flags_copy):
