...
from coldfront.core.utils.reporting.report_message_strategy import (
    EnqueueForLoggingStrategy,
    WriteViaCommandStrategy,
)
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            self.stderr.write(self.style.ERROR(f'User "{username_1}" does not exist.'))
            return
        ...
        try:
            ...
            self.stderr.write(self.style.ERROR(f'User "{username_2}" does not exist.'))
            return
        ...
        reporting_strategies = [
            write_via_command_strategy,
            enqueue_for_logging_strategy,
        ]
