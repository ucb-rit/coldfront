...
class UserSearchListForm(forms.Form):
    ...
    email = forms.EmailField(
        ...
        required=False,
        help_text=(
            "You may use this field to find the user that an email address belongs to, even if it is not a primary address."
        ),
    )
...
class UserAccessAgreementForm(forms.Form):
    ...
    acknowledgement = forms.BooleanField(
        initial=False, label="Acknowledge & Sign", required=True
    )
