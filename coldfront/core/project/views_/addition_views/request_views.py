...
from coldfront.core.project.utils_.addition_utils import (
    ...
    has_pending_allocation_addition_request,
)
...
class AllocationAdditionRequestLandingView(
    ...
    template_name = "project/project_allocation_addition/request/request_landing.html"
    ...
    def get_context_data(self, **kwargs):
        ...
        context["has_pending_request"] = has_pending_allocation_addition_request(
            self.project_obj
        )
        ...
        try:
            ...
            allocation_attribute_usage = allocation_attribute.allocationattributeusage
        ...
        try:
            quotient = context["current_usage"] / context["current_allowance"]
...
class AllocationAdditionRequestView(LoginRequiredMixin, UserPassesTestMixin, FormView):
    """A view for creating requests to purchase more Service Units for
    the given Project."""

    form_class = SavioProjectRechargeExtraFieldsForm
    template_name = "project/project_allocation_addition/request/request_form.html"
    ...
    def form_valid(self, form):
        ...
        try:
            ...
            request = AllocationAdditionRequest.objects.create(**request_kwargs)
    ...
    def send_email(request):
        ...
        try:
            ...
            template_name = "email/project_allocation_addition/admins_new_request.txt"
