...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        manual_parser = subparsers.add_parser(
            "manual", help="Set the AllocationPeriod for a particular request."
        )
        manual_parser.add_argument(
            "request_id", help="The ID of the SavioProjectAllocationRequest.", type=int
        )
        manual_parser.add_argument(
    ...
    def handle_auto(self, *args, **options):
        ...
        requests_without_periods = SavioProjectAllocationRequest.objects.filter(
    ...
    def set_allocation_period_for_request(
        self, request, allocation_period, dry_run=False
    ):
