...
class TestAllocationRenewalRequestViewMixin:
    ...
    def _send_post_requests_for_pooling_preference(
        self,
        pooling_preference,
        allocation_period,
        pi_project_user,
        ...
        if pooling_preference == AllocationRenewalRequest.POOLED_TO_UNPOOLED_NEW:
...
class TestBRCAllocationRenewalRequestView(
    TestAllocationRenewalRequestViewMixin, TestBase
):
...
class TestLRCAllocationRenewalRequestView(
    TestAllocationRenewalRequestViewMixin, LRCTestBase
):
    ...
    def test_billing_id_not_required_if_pi_not_pi_of_requested_project(self):
        ...
        billing_activity = get_or_create_billing_activity_from_full_id(billing_id)
        ...
        pi_project_user_manager = ProjectUserBillingActivityManager(dst_pi_project_user)
    ...
    def test_billing_id_required_if_creating_new_project(self):
        ...
        self._send_post_requests_for_pooling_preference(
            ...
            allocation_period,
            pi_project_user,
            new_project_dict=new_project_dict,
        ...
        self.assertTrue(isinstance(new_project_request, SavioProjectAllocationRequest))
        ...
        self.assertEqual(new_project.description, new_project_dict["description"])
    ...
    def test_post_updates_matching_billing_activities_pooling(self):
        ...
        pi_project_user_manager = ProjectUserBillingActivityManager(pi_project_user)
        assert pi_project_user_manager.billing_activity == billing_activity
        ...
        assert other_pi_project_user_manager.billing_activity == billing_activity

        other_pi_user_manager = UserBillingActivityManager(other_pi_project_user.user)
        ...
        other_billing_activity = get_or_create_billing_activity_from_full_id(
            other_billing_id
        )
        ...
        assert other_pi_project_user_manager.billing_activity == other_billing_activity
