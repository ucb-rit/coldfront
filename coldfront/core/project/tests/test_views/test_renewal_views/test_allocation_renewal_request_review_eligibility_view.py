...
class TestAllocationRenewalRequestReviewEligibilityView(
    TestBase, TestRenewalViewsMixin
):
    """A class for testing
    ...
    def pi_allocation_renewal_request_review_eligibility_url(pk):
        ...
        key."""
        return reverse(
            "pi-allocation-renewal-request-review-eligibility", kwargs={"pk": pk}
        )
    ...
    def test_post_updates_request_state_and_status(self):
        ...
        self.assertEqual(self.allocation_renewal_request.status.name, "Under Review")
