...
class TestAllocationRenewalRequestDetailView(TestBase, TestRenewalViewsMixin):
    ...
    def setUp(self):
        ...
        project, self.allocation_renewal_request = self.create_project_and_request(
    ...
    def test_permissions_get(self):
        ...
        self.allocation_renewal_request.save()
        permission = Permission.objects.get(codename="view_allocationrenewalrequest")
    ...
    def test_post_approves_and_processes_request_for_started_period(self):
        ...
        self.assertEqual(response.url, self.pi_allocation_renewal_request_list_url())
        ...
        expected_num_service_units = (
            self.existing_service_units + allocation_renewal_request.num_service_units
        )
        self.service_units_attribute.refresh_from_db()
        self.assertEqual(
            expected_num_service_units, Decimal(self.service_units_attribute.value)
        )
    ...
    def test_post_blocked_until_checklist_complete_existing_project(self, mock_method):
    ...
    def test_post_blocked_until_checklist_complete_new_project(self, mock_method):
        ...
        self.allocation_renewal_request.new_project_request = new_project_request
        self.allocation_renewal_request.save()
        ...
        new_project_request.status = ProjectAllocationRequestStatusChoice.objects.get(
