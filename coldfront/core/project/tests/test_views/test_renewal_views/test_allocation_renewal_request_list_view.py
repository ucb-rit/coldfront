...
class TestViewMixin(TestRenewalViewsMixin):
    ...
    def test_search_form_visibility(self):
        ...
        perm = Permission.objects.get(codename="view_allocationrenewalrequest")
...
class TestAllocationRenewalRequestCompletedListView(TestViewMixin, TestBase):
    ...
    def setUp(self):
        ...
        self.request_a.status = AllocationRenewalRequestStatusChoice.objects.get(
            name="Approved"
        )
        self.request_a.save()
        self.request_b.status = AllocationRenewalRequestStatusChoice.objects.get(
            name="Complete"
        )
        self.request_b.save()
