...
class TestAllocationRenewalRequestReviewMemorandumSignedView(TestBase):
    ...
    def review_memorandum_signed_url(pk):
        ...
        return reverse(
            "service-units-purchase-request-review-memorandum-signed", kwargs={"pk": pk}
        )
    ...
    def test_permissions_get(self):
        ...
        requests."""
        url = self.review_memorandum_signed_url(self.allocation_addition_request.pk)
    ...
    def test_post_updates_request_state(self):
        ...
        self.assertIn("has been set to Complete", self.get_message_strings(response)[0])
