...
class TestFCASubmission(_WizardMixin):
    ...
    def test_creates_request_and_project(self):
        ...
        self._post_step('allocation_period', {'allocation_period': allocation_period.pk})
        ...
        request = SavioProjectAllocationRequest.objects.get(
            requester=self.user)
    ...
    def test_survey_answers_stored(self):
        ...
        assert request.survey_answers['computational_aspects'] == _SURVEY['computational_aspects']
