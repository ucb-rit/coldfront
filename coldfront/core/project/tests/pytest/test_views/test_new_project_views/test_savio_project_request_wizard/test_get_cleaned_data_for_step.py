...
class TestGetCleanedDataForStepCache:
    ...
    def test_current_step_calls_super_every_time(self):
        ...
        with patch.object(
            SessionWizardView, "get_cleaned_data_for_step", return_value=data
        ) as super_mock:
    ...
    def test_different_steps_cached_independently(self):
        ...
        with patch.object(
            SessionWizardView, "get_cleaned_data_for_step", side_effect=_side_effect
        ) as super_mock:
            wizard.get_cleaned_data_for_step("0")
            wizard.get_cleaned_data_for_step("2")
            wizard.get_cleaned_data_for_step("0")
    ...
    def test_none_result_not_cached(self):
        ...
        with patch.object(
            SessionWizardView, "get_cleaned_data_for_step", return_value=None
        ) as super_mock:
            wizard.get_cleaned_data_for_step("0")
            wizard.get_cleaned_data_for_step("0")
    ...
    def test_none_then_data_is_cached(self):
        ...
        with patch.object(
            SessionWizardView, "get_cleaned_data_for_step", side_effect=side_effects
        ) as super_mock:
            result1 = wizard.get_cleaned_data_for_step("0")
            result2 = wizard.get_cleaned_data_for_step("0")
