...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('resource', '0004_historicaltimedresourceattribute_timedresourceattribute'),
    ]
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            ...
            options={'get_latest_by': ('history_date', 'history_id'), 'ordering': ('-history_date', '-history_id'), 'verbose_name': 'historical timed resource attribute', 'verbose_name_plural': 'historical timed resource attributes'},
        ),
        ...
        migrations.AlterField(
            model_name='historicaltimedresourceattribute',
            name='history_date',
            field=models.DateTimeField(db_index=True),
        ),
    ]
