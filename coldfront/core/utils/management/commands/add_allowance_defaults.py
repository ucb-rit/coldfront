...
class Command(BaseCommand):
    ...
    def create_allowance_resources_and_attributes(self, data):
        ...
        for allowance in data:
            ...
            for resource_attribute_type, start_date, end_date, value in allowance.get(
                "timed_attributes", []
            ):
            ...
            "BRC_ONLY": [
                {
                    ...
                    "description": ("A free computing allowance available to faculty."),
                    "attributes": [
                ...
                },
                {
                    ...
                    "description": (
                        "A free computing allowance available to instructors."
                    ),
                    "attributes": [
                        (self.name_long, "Instructional Computing Allowance (ICA)"),
                        (self.name_short, "ICA"),
                        (self.code, "ic_"),
                    ],
                },
                {
                    ...
                    "description": (
                        "A free computing allowance available in special cases."
                    ),
                    "attributes": [
            ...
            "LRC_ONLY": [
                {
                    ...
                    "description": ("A free computing allowance available to PIs."),
                    "attributes": [
                ...
                },
                {
                    ...
                    "attributes": [
                        (self.service_units, f"{settings.ALLOCATION_MAX}"),
                        (self.name_long, "Recharge Allocation (Pay for Used Time)"),
                        (self.name_short, "RECHARGE"),
                        (self.code, "ac_"),
                    ],
                },
                    ...
                    if allowance["name"] in service_units_data:
                        ...
                        for allocation_period_value in service_units_data[
                            ...
                            allocation_period = AllocationPeriod.objects.get(
                                name=allocation_period_value["allocation_period"]
                            )
