...
resources = [
    ...
    (
        ...
        "Physics",
        "Physics-scavenger",
        "Scavenger partition on Physics cluster",
        True,
        False,
        False,
    ),
    ...
    (
        ...
        None,
        "server-cgray",
        "Server for Carl Gray's research lab",
        True,
        False,
        True,
    ),
    (
        ...
        None,
        "server-sfoster",
        "Server for Stephanie Foster's research lab",
        True,
        False,
        True,
    ),
    ...
    (
        ...
        None,
        "Budgetstorage",
        "Low-tier storage option - NOT BACKED UP",
        True,
        True,
        True,
    ),
    (
        ...
        None,
        "ProjectStorage",
        "Enterprise-level storage - BACKED UP DAILY",
        True,
        True,
        True,
    ),
