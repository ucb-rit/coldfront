...
try:
    ...
    print(
        "local_strings.py file is required. Copy coldfront/config/local_strings.py.sample to local_strings.py"
    )
    sys.exit()
...
try:
    ...
    print(
        "local_settings.py file is required. Copy coldfront/config/local_settings.py.sample to local_settings.py"
    )
    sys.exit()
