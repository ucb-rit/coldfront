...
class TestBillingBase(TestAPIBase):
    ...
    def setUp(self):
        ...
        self.user0 = User.objects.create_user(
            email="user0@nonexistent.com", username="user0", password=self.password
        )

        # Create two BillingProjects, each with two BillingActivities.
        self.billing_project0 = BillingProject.objects.create(identifier="000000")
        self.billing_project1 = BillingProject.objects.create(identifier="100000")
        # 000000-000
