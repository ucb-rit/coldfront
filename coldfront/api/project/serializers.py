...
class ProjectUserSerializer(serializers.ModelSerializer):
    ...
    status = serializers.SlugRelatedField(
        slug_field="name", queryset=ProjectUserStatusChoice.objects.all()
    )
    role = serializers.SlugRelatedField(
        slug_field="name", queryset=ProjectUserRoleChoice.objects.all()
    )
...
class ProjectUserRemovalRequestSerializer(serializers.ModelSerializer):
    ...
    status = serializers.SlugRelatedField(
        slug_field="name", queryset=ProjectUserRemovalRequestStatusChoice.objects.all()
    )
