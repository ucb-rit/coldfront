...
class TestListAllocationUserAttributes(TestAllocationBase):
    ...
    def endpoint_url(self, allocation_user_pk):
        ...
        return f"{self.allocation_users_base_url}{allocation_user_pk}/attributes/"
    ...
    def test_no_filters(self):
        ...
        for result in json["results"]:
            ...
            self.assertEqual(
                allocation_user_attribute.allocation_user.id, result["allocation_user"]
            )
...
class TestRetrieveAllocationUserAttributes(TestAllocationBase):
    ...
    def test_invalid_pk(self):
        ...
        an error."""
        allocation_user = AllocationUser.objects.first()
        pk = sum(AllocationUserAttribute.objects.values_list("pk", flat=True)) + 1
