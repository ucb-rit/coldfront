...
from coldfront.api.allocation.views import (
    AllocationAttributeViewSet,
    AllocationUserAttributeViewSet,
    AllocationUserViewSet,
    AllocationViewSet,
    ClusterAccessRequestViewSet,
    HistoricalAllocationAttributeViewSet,
    HistoricalAllocationUserAttributeViewSet,
)

router = DefaultRouter()

router.register(r"allocations", AllocationViewSet, basename="allocations")
allocations_router = NestedSimpleRouter(router, r"allocations", lookup="allocation")
allocations_router.register(
    r"attributes", AllocationAttributeViewSet, basename="attributes"
)
...
router.register(r"allocation_users", AllocationUserViewSet, basename="allocation_users")
