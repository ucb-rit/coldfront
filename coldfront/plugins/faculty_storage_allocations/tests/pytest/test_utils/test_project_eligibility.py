...
class TestProjectEligibilityForFacultyStorageAllocations:
    ...
    def test_fca_project_is_eligible(self, db, project_status_choice_active):
    ...
    def test_ica_project_is_not_eligible(self, db, project_status_choice_active):
    ...
    def test_pca_project_is_not_eligible(self, db, project_status_choice_active):
    ...
    def test_condo_project_is_not_eligible(self, db, project_status_choice_active):
        ...
        assert (
            is_project_eligible_for_faculty_storage_allocations(condo_project) is False
        )

    def test_recharge_project_is_not_eligible(self, db, project_status_choice_active):
        ...
        assert (
            is_project_eligible_for_faculty_storage_allocations(recharge_project)
            is False
        )
