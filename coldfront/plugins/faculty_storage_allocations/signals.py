...
from coldfront.plugins.faculty_storage_allocations.services.directory_service import (
    DirectoryService,
)
...
def add_project_user_to_faculty_storage_allocation(sender, **kwargs):
    ...
    if not project or not user:
        logger.warning("project_user_activated signal received without project or user")
        return
...
def remove_project_user_from_faculty_storage_allocation(sender, **kwargs):
    ...
    if not project or not user:
        logger.warning("project_user_removed signal received without project or user")
        return
