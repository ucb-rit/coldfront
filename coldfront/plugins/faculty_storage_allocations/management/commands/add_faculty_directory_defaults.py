...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        path = ResourceAttributeType.objects.get(
            attribute_type=AttributeType.objects.get(name="Text"), name="path"
        )
        ...
        scratch_faculty_storage_path, _ = ResourceAttribute.objects.get_or_create(
            resource_attribute_type=path,
        ...
        for name in faculty_storage_allocation_request_status_choice_names:
            FacultyStorageAllocationRequestStatusChoice.objects.get_or_create(name=name)
