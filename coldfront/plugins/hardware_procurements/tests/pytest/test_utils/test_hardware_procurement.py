...
class TestHardwareProcurement(object):
    ...
    def test_get_data_returns_copy(self):
        ...
        assert output_2["initial_inquiry_date"] != output_1["initial_inquiry_date"]
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            # different IDs.
            (("pi1@email.com,pi2@email.com", "CPU", "01/01/1970", 0, {}), "84a3a48d"),
            (("pi1@email.com,pi2@email.com", "CPU", "01/01/1970", 1, {}), "87c7e8f4"),
            (("pi1@email.com,pi2@email.com", "CPU", "01/01/1970", 2, {}), "026115ca"),
        ],
    )
    ...
    def test_is_user_associated(
        self, pi_emails, poc_emails, user_data_to_test, expected_is_associated
    ):
        ...
        assert hp.is_user_associated(user_data_to_test) == expected_is_associated
