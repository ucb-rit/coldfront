...
from ....utils.data_sources.backends.cached import (
...
class TestCachedDataSourceBackend:
    ...
    def test_init_instantiates_underlying_backend(self, cached_google_sheets_backend):
    ...
    @pytest.mark.component
    def test_init_instantiates_cache_manager(self, cached_google_sheets_backend):
    ...
    def test_init_skips_cache_populate_if_not_needed(
        self, mock_cache, cached_data_source_kwargs
    ):
        with patch.object(
            HardwareProcurementsCacheManager, "populate_cache"
